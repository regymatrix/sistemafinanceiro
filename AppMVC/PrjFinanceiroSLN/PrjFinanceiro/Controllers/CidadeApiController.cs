...
namespace PrjFinanceiro.Controllers
{
    ...
    public class CidadeApiController : ControllerBase
    {
        ...
        // POST: api/CidadeApi
        [HttpPost]
        public IActionResult Cadastrar([FromBody] Cidade dto)
        {
        ...
        // PUT: api/CidadeApi/5
        [HttpPut("{id}")]
        public IActionResult Atualizar(int id, [FromBody] Cidade dto)
        {
            ...
            if (cidadeNoBanco == null)
            {
                return NotFound(new
                {
                    message = $"Cidade com código {id} não encontrada para atualização."
                });
            }
        ...
        public IActionResult Remover(int id)
        {
            ...
            if (cidade == null)
            {
                return NotFound(new
                {
                    message = $"Cidade com código {id} não encontrada para exclusão."
                });
            }
