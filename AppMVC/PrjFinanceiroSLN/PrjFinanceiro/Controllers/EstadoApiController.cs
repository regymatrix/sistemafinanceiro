...
namespace PrjFinanceiro.Controllers
{
    ...
    public class EstadoApiController : ControllerBase
    {
        ...
        {
            var estados = _context.Agencia.ToList();
        ...
        public IActionResult BuscarPorId(int id)
        {
            ...
            if (estado == null)
            {
                return NotFound(new { message = $"Estado com código {id} não encontrada." }); // HTTP 404
            }
        ...
        public IActionResult Atualizar(int id, [FromBody] EstadoCreateDto dto)
        {
            ...
            {
                return NotFound(new { message = $"Estado de código {id} inexistente para atualização." });
            }
        ...
        public IActionResult Remover(int id)
        {
            ...
            return Ok(new { success = true, message = "Estado excluída com sucesso diretamente pela API!" }); // HTTP 200
        }
    }
}
