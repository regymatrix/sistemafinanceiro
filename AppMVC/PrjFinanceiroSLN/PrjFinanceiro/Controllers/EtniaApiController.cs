    ...
    public class EtniaApiController : ControllerBase
    {
        ...
        public IActionResult BuscarPorId(int id)
        {
            ...
            if (etnia == null)
            {
                return NotFound(new
                {
                    message = $"Etnia com código {id} não encontrada."
                });
            }
        ...
        public IActionResult Atualizar(int id, [FromBody] EtniaCreateDto dto)
        {
            ...
            if (etniaNoBanco == null)
            {
                return NotFound(new
                {
                    message = $"Etnia de código {id} inexistente para atualização."
                });
            }
        ...
        public IActionResult Remover(int id)
        {
            ...
            if (etnia == null)
            {
                return NotFound(new
                {
                    message = $"Etnia de código {id} não encontrada para exclusão."
                });
            }
            ...
            return Ok(new
            {
                success = true, message = "Etnia excluída com sucesso diretamente pela API!"
            });
        }
    }
}